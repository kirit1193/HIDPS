...
def mainUI():
	global main_win, border_in, t, border_out, t1, border_misc, t2, border_buttons, border_buttons1, border_buttons2, countinPackets, countoutPackets, inpCount, outpCount, aboutbutton, quitButton, viewip, parseButton, screen_height, screen_width,pauseButton,optionMenu,Omenu
	main_win = Tk()
	...
	#image=Image.open("IPtable.png")
	#photo=ImageTk.PhotoImage(image)
	#viewip = Button(border_buttons, width=70,height=30,image=photo,command=ipTables)
	#viewip.image=photo
	#viewip.pack(side="left",ipadx=10,pady=7)
	
	parseButton = Button(border_buttons, text='Parse IP', command=parseClick)
